	...
	tests := []struct {
		...
		},
		{
			...
			descriptor: Descriptor{Fields: []Field{
				{Label: colName, Value: rowAcme},
				{Label: labelTransport, Value: valGit},
				{Label: labelURI, Value: "git@github.com:acme/artifacts.git"},
			}},
			want: "name:       acme\n" +
				"transport:  git\n" +
		...
		},
		{
			...
			descriptor: Descriptor{Fields: []Field{
				{Label: colName, Value: rowAcme},
				{Label: labelTransport, Value: valGit},
				{Label: labelAuth, Children: []Field{
...
func TestDescriptorRenderWriteError(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			descriptor: Descriptor{Fields: []Field{
				{Label: "auth", Children: []Field{{Label: "username", Value: "u"}}},
			}},
			writeAfter: 0,
		},
		{
