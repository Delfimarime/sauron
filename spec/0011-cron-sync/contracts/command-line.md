...
Defines the command-line interface for scheduling [`sauron sync artifacts`](../../0006-sync-artifacts/spec.md) via the operating system's cron. This is the user-facing contract only.
