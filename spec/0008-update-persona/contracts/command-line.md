...
|----------|----------|-------------|
| `<path>` | Yes | Path to the persona definition file (YAML, same format as [import persona](../../0005-import-persona/contracts/command-line.md)). Realizes [spec](../spec.md) FR-002, FR-009, FR-010. |
...
|------|---------|----------|
| `0` | Persona updated | [spec](../spec.md) FR-005, FR-007 |
| `2` | Usage error — missing `<path>` | [spec](../spec.md) FR-009 |
| `1` | Validation error — definition unreadable/malformed, invalid or missing name, missing description, no artifacts, persona not found, or the settings unreadable | [spec](../spec.md) FR-010, FR-011, FR-012, FR-013, FR-014, FR-015 |
