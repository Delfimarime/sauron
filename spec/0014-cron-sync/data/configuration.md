...
| Field | Type | Required | Description |
|-------|------|----------|-------------|
| `sync` | string | No | The cron expression for the scheduled `sauron sync`. Realizes FR-003. |
...
- The scheduled command is plain `sauron sync` — it carries no flags and follows the configured global target and personas. Realizes FR-004.
