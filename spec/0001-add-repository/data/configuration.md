# Data Model: Configuration — Sauron Settings (Repository)

**Spec**: [Add Repository](../spec.md)

Describes the persisted configuration that the Add Repository feature reads
and writes, covering all repository kinds
...
Repository entry — common fields (all kinds):
