...
// track.yaml. Mirrors spec/contracts/schemas/Persona.schema.json.
type Persona struct {
...
// PersonaSpec is the spec block of a Persona document. Mirrors the spec object
// in spec/contracts/schemas/Persona.schema.json.
...
// sync/upgrade. Mirrors spec.members in spec/contracts/schemas/Persona.schema.json.
