...
// cycle unchanged, using representative documents drawn from
// spec/contracts/configuration.md. It is purely in-memory — no filesystem.
	...
	tests := []struct {
		...
		},
		{
			...
			doc: &types.Skill{
				...
				Spec: types.ArtifactSpec{
					...
					Provenance:  types.Provenance{Direct: true, Personas: []string{"backend-dev"}},
		...
		},
		{
			...
			doc: &types.Agent{
				...
				Spec: types.ArtifactSpec{
					...
					Provenance:  types.Provenance{Direct: false, Personas: []string{"backend-dev"}},
					InstalledAt: "2026-06-15T10:00:00Z",
					UpdatedAt:   "2026-06-15T10:00:00Z",
				},
			},
		...
		},
		{
			...
			doc: &types.Persona{
				...
				Metadata: types.Metadata{Name: "backend-dev"},
